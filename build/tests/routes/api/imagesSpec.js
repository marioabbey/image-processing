...
describe("Test invalid scenarios passed in the url", () => {
    ...
    it("returns 404 when no height and width is passed filename is passed", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("Test for all scenarios passed in the url", () => {
    ...
    afterAll(() => {
        fs_1.default.rmSync("build/assets", { recursive: true });
    });
    it("returns 200 when valid details  are  passed", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get("/api/images?filename=palmtunnel&width=20&height=10");
